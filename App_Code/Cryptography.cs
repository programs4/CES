...
public static class Cryptography
{
    ...
    public static string Encrypt(this string textToEncrypt)
    {
        ...
        {
            DALC.ErrorLogs(string.Format("Cryptography.Encrypt catch error: (Text: {0}) {1}  |  Url: {2}", textToEncrypt, er.Message, HttpContext.Current.Request.Url.ToString()));
            return "";
        }
    }
