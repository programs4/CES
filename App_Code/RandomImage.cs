...
public class RandomImage
{
    ...
    private void GenerateImage()
    {
        ...
        HatchBrush hatchBrush = new HatchBrush(HatchStyle.ZigZag,
        ...
        hatchBrush = new HatchBrush(HatchStyle.Percent10, Color.Black, Color.Silver);
        g.FillPath(hatchBrush, path);
        int m = Math.Max(rect.Width, rect.Height);
        for (int i = 0; i < (int)(rect.Width * rect.Height / 300F); i++)
        {
