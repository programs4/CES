<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Tools_Evaluations_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderBody" runat="Server">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <br />
            <div class="GrdList">
                <asp:GridView ID="GrdEvaluations" runat="server" AutoGenerateColumns="False" BorderColor="#CDCDCD" BorderWidth="0px" CellPadding="4" ForeColor="#051615" Width="100%" CssClass="boxShadow" Font-Bold="True" DataKeyNames="ID">
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <a href="/tools/evaluations/add/?i=<%# string.Format(Config._GetQueryString("i")+"&id={0}",Eval("ID")._ToString().Encrypt()) %>">
